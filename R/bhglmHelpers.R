#' Internal BhGLM helper functions
#'
#' These functions replicate internal components of the BhGLM package
#' to support Bayesian Cooperative Learning and related extensions.
#'
#' @import glmnet
#' @keywords internal
NULL
